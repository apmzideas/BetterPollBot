...
class TelegramApi(object):
    def __init__(self, token, LoggingObject, LanguageObject):
        ...
        self.logger = logger  # holds the logging Objekt
    ...
    def GetMe(self):
        ...
        if JSONData["ok"]:
            ...
            raise ErrorClasses.TokenError(Language.LanguageClass.GetStringName())
...
if __name__ == "__main__":
    import pprint
    a = TelegramApi("80578257:AAEt5tHodsbD6P3hqumKYFJAyHTGWEgcyEY", LoggingClass.Logger())
    if a:
